...
Mort_P = seq(0.01, 1, 0.1)
Mort_M = seq(0.01, 1, 0.1)

Mort_PM <- expand.grid("mortality_P" = Mort_P, "mortality_M" = Mort_M)

#Simulate model output and calculate the RE
RE_mortality_PM <-
        Simulate_Model_Output(param_standard, c("mortality_P", "mortality_M"), 
                                                Mort_PM) |>
...
ggsave(here("Figures", "supp_pm_removal.pdf"), units = 'in', width = 11, height = 11)
